...
function showWelcome() {
    ...
    let dist = getDistance(113.943041, 22.509133, ipLocation.data.lng, ipLocation.data.lat);
...
function showWelcome() {
    ...
    try {
        ...
        welcomeInfoElement.innerHTML =
            `欢迎来自 <b><span style="color: var(--kouseki-ip-color);font-size: var(--kouseki-gl-size)">${pos}</span></b> 的小友💖<br>${posdesc}🍂<br>当前位置距博主约 <b><span style="color: var(--kouseki-ip-color)">${dist}</span></b> 公里！<br>您的IP地址为：<b><span style="font-size: 14px;">${ip}</span></b><br>${timeChange} <br>`;
